   ...
   - Completar las clases "VSocket" y "Socket" para poder intercambiar mensajes entre procesos que no comparten memoria.
     Para este trabajo deben completar:
      ...
      - Clase "VSocket"
        ...
        VSocket::Init( int ), es el "constructor" de la clase VSocket, recibe el descriptor generado por
      ...
      - Clase "Socket"
        VSocket * WaitForConnection(), acepta una solicitud de conexión TCP y crea un nuevo "handle" para intercambiar
